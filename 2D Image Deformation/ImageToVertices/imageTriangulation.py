...
parser.add_option('-f', '--file', dest='filepath', default=os.getcwd() + '/pingu.jpg',
...
file_path = 'vertices.json'
with open(file_path, 'w') as f:
    json.dump(triangles.simplices.tolist(), f)
############## 문제점 : vscode의 작업 영역에서 파일 경로 시작점을 어떻게 현재 폴더로 설정하는 지 알 수가 없음
